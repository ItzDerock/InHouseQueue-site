...
export default function Terms() {
  return (
    <>
      {/* change page title */}
      <Head>
        <title>Terms and Conditions | In-House Queue</title>
      </Head>
      ...
      <div
        ...
        className={`content mx-auto w-full max-w-6xl items-center text-left text-white ${styles["terms"]!}`}
      >
        ...
        <ol>
          ...
          <li>
            <p>
              ...
              between You and InHouseQueue regarding the use of the Service. This
          ...
          <li>
            <p>
              ...
              Service, or InHouseQueue, or other legal entity on behalf of which
        ...
        <p>
          ...
          and the agreement that operates between You and InHouseQueue. These
        ...
        <p>
          You represent that you are over the age of 18. InHouseQueue does not
          permit those under 18 to use the Service.
        </p>
        <p>
          Your access to and use of the Service is also conditioned on Your
          acceptance of and compliance with the Privacy Policy of InHouseQueue.
        ...
        <p>
          ...
          that are not owned or controlled by InHouseQueue.
        </p>
        <p>
          InHouseQueue has no control over, and assumes no responsibility for,
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that InHouseQueue
        ...
        <p>
          ...
          of InHouseQueue and any of its suppliers under any provision of this
        ...
        <p>
          ...
          InHouseQueue or its suppliers be liable for any special, incidental,
          ...
          provision of this Terms), even if InHouseQueue or any supplier has been
        ...
        <p>
          ...
          permitted under applicable law, InHouseQueue, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, InHouseQueue
        ...
        <p>
          Without limiting the foregoing, neither InHouseQueue nor any of the
          ...
          of InHouseQueue are free of viruses, scripts, trojan horses, worms,
        ...
        <p>
          ...
          first try to resolve the dispute informally by contacting InHouseQueue.
        </p>
